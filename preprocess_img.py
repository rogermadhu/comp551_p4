...
def main(arguments):
    ...
    parser.add_argument('--raw_file', '--Data/omniglot/chardata.mat', help="path to chardata.mat file")
    parser.add_argument('--output','--Data/chardata.pt', help="where to save the hdf5 file")
    args = parser.parse_args(arguments)
    load_omniglot('Data/omniglot/chardata.mat', 'Data/chardata.pt')
